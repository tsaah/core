...
CREATE TABLE `achievement_reward` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci ROW_FORMAT=FIXED COMMENT='Loot System';

-- Dumping data for table mangos.achievement_reward: 100 rows
